...
class SQLiteManager:
    ...
    def create_tables(self) -> bool:
        ...
        try:
            ...
            cursor.execute(
                "CREATE INDEX IF NOT EXISTS idx_newsletters_genre ON newsletters(genre)"
            )
    ...
    def get_newsletters_by_date_range(
        ...
        try:
            ...
            print(
                f"📊 Retrieved {len(newsletters)} newsletters from {start_date} to {end_date}"
            )
            return newsletters
    ...
    def get_newsletters_by_genre(self, genre: str, days: int = 7) -> List[Dict]:
        ...
        try:
            ...
            print(
                f"📊 Retrieved {len(newsletters)} {genre} newsletters from last {days} days"
            )
            return newsletters
